...
int main()
{
    ...
    FluidState fluid_attributes = FluidState(numParticles, WIDTH, HEIGHT, gridNumX, gravityX, gravityY, thread_pool);
    ...
    Fluid fluid = Fluid(divergenceModifier, diffusionRatio, vorticityStrength, flipRatio, overRelaxation, numPressureIters, fluid_attributes, pressure_solver, fluid_renderer);
